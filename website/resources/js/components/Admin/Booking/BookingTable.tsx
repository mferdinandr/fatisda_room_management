                        ...
                        <TableRow key={booking.id}>
                            ...
                            <TableCell>
                                <div className="space-y-1">
                                    ...
                                    {booking.mata_kuliah && <p className="text-muted-foreground text-sm">Subject: {booking.mata_kuliah}</p>}
                                    {booking.dosen && <p className="text-muted-foreground text-sm">Lecturer: {booking.dosen}</p>}
                                </div>
                            </TableCell>
                            ...
                            <TableCell>
                                <div className="space-y-1">
                                    ...
                                    {booking.catatan && <p className="text-muted-foreground max-w-xs truncate text-xs">{booking.catatan}</p>}
                                </div>
                            </TableCell>
                            ...
                            <TableCell>
                                ...
                                {booking.admin_notes && (
                                    <p className="text-muted-foreground mt-1 max-w-xs truncate text-xs">Note: {booking.admin_notes}</p>
                                )}
                            </TableCell>

                            <TableCell>
                                <span className="text-muted-foreground text-sm">{formatDateTime(booking.created_at)}</span>
                            </TableCell>
