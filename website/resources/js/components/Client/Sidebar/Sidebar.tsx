...
const Sidebar = () => {
    ...
    return (
        <div
            className={`bg-background absolute top-28 bottom-0 left-0 flex flex-col transition-all duration-300 ease-in-out ${isOpen ? 'w-70 p-3 md:p-4' : 'w-14 p-2'} rounded-tr-2xl`}
        >
